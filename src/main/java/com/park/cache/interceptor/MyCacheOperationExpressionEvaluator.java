 ...
 * @date 2020/6/7 21:08
 */
public class MyCacheOperationExpressionEvaluator extends CachedExpressionEvaluator {
	...
	public EvaluationContext createEvaluationContext(Collection<? extends Cache> caches,
		...
		MyCacheExpressionRootObject rootObject = new MyCacheExpressionRootObject(
				caches, method, args, target, targetClass);
		MyCacheEvaluationContext evaluationContext = new MyCacheEvaluationContext(
